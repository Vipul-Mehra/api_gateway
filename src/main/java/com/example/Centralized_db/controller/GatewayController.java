...
public class GatewayController {
    ...
    public ResponseEntity<ProductAccessResponse> checkAccess(@RequestBody ProductAccessRequest request) {
        ...
        // 3. Verify that the realm (via client subscription) is subscribed to the product
        boolean subscribed = subscriptionRepository.existsByClientRealmNameAndProductProductName(
                request.getRealm(),
                request.getProduct()
        );
    ...
    public static class ProductAccessResponse {
        ...
        public static ProductAccessResponse allowed(String message, String productUri, String roleName) {
